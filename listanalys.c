...
int main(void)
{
  ...
  printf("EXPERIMENT PÃ… LISTA\n"
	 "======================================================================\n"
	 "\n"
	 "Det hÃ¤r programmet mÃ¤ter tiden det tar att sÃ¤tta in n vÃ¤rden i en\n"
	 "lista. Experimentet omfattar mÃ¥nga olika problemstorlekar och\n"
	 "resultaten presenteras i textformat pÃ¥ stdout med tab-separerade\n"
	 "kolumner. Tiden mÃ¤ts i sekunder.\n"
	 "\n"
	 "RESULTAT\n"
	 "======================================================================\n"
	 "\n");
